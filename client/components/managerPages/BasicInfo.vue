...
#manager-basicInfo .container-email .email-sid-delete:hover,
#manager-basicInfo .container-email .email-sid-delete:focus {
  color: red;
  text-decoration: none;
  cursor: pointer;
}
...
#manager-basicInfo .container-email #email-sid-add-button:hover,
#manager-basicInfo .container-email #email-sid-add-button:focus {
