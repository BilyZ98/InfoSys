...
export default {
  ...
  schoolRoll: {
    ...
    records: {
      ...
      isRollChanged: { name: '学籍是否有变动', id: 'isRollChanged', isPrimary: false, display: true, value: '', valueType: 'select', options: ['是', '否'] },
  ...
  partyInfo: {
    ...
    records: {
      ...
      activerTime: { name: '确定入党积极分子时间', id: 'activerTime', isPrimary: false, display: true, value: '', valueType: 'input' },
      ...
      developerTime: { name: '确定重点发展对象时间', id: 'developerTime', isPrimary: false, display: true, value: '', valueType: 'input' },
      ...
      probationaryTime: { name: '预备党员起始时间', id: 'probationaryTime', isPrimary: false, display: true, value: '', valueType: 'range' },
      ...
      fullMemberTime: { name: '正式党员起始时间', id: 'fullMemberTime', isPrimary: false, display: true, value: '', valueType: 'range' },
  ...
  techProject: {
    ...
    records: {
      sid: { name: '学号', id: 'sid', isPrimary: true, display: true, value: '', valueType: 'input' },
      name: { name: '姓名', id: 'name', isPrimary: false, display: true, value: '', valueType: 'input' },
      proName: { name: '项目名称', id: 'proName', isPrimary: false, display: true, value: '', valueType: 'input' },
