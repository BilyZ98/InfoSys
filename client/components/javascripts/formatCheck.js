...
export default {
  ...
  HMTStudent: {
    sid: { canNull: false, reg: /^[1-9][\d]{7}$/, msg: '学号格式错误' },
    name: { canNull: false, reg: null, msg: '' },
    hometown: { canNull: false, reg: null, msg: '' },
    speciality: { canNull: true, reg: null, msg: '' },
    mail: { canNull: true, reg: /^[a-zA-Z0-9_-]+@[a-zA-Z0-9_-]+(\.[a-zA-Z0-9_-]+)+$/, msg: '邮箱格式有误' },
    wechat: { canNull: true, reg: null, msg: '' },
    homeAddress: { canNull: true, reg: null, msg: '' },
    economicManName: { canNull: true, reg: null, msg: '' },
    economicManPhone: { canNull: true, reg: null, msg: '' },
    HMTIdNum: { canNull: false, reg: ((/[A-Z]{1,2}[0-9]{6}([0-9A])/)|(/^[1|5|7][0-9]{6}[0−9Aa][0−9Aa]/)|(/[A-Z][0-9]{9}/)), msg: '身份证号填写有误' },
    reetryPermit: {canNull: false, reg: null, msg: ''}
  },
  InternationalStu: {
    sid: { canNull: false, reg: /^[1-9][\d]{7}$/, msg: '学号格式错误' },
    passportName: { canNull: false, reg: null, msg: '' },
    stuGroup: { canNull: false, reg: null, msg: '' },
    name: { canNull: false, reg: null, msg: '' },
    gender: { canNull: false, reg: null, msg: '' },
    Nationality: { canNull: false, reg: null, msg: '' },
    passportNum: { canNull: false, reg: null, msg: '' },
    schools: {canNull: false, reg: null, msg: '' },
    major: {canNull: false, reg: null, msg: '' },
    tutor: {canNull: true, reg: null, msg: '' },
    visaType: {canNull: false, reg: null, msg: ''},
    residencePurpose: {canNull: true, reg: null, msg: ''},
    visaDateDue: { canNull: false, reg: /^[0-9]{4}\/[0-9]{2}\/[0-9]{2}/, msg: '日期格式应为YYYY/MM/DD'},
    remark: {canNull: true, reg: null, msg: ''},
    religion: { canNull: true, reg: null, msg: ''},
    ethnic: { canNull: false, reg: null, msg: ''},
    clubParticipation: { canNull: true, reg: null, msg: ''},
    campusActivities: { canNull: true, reg: null, msg: ''},
    disciplinarySituation: { canNull: true, reg: null, msg: ''},
    DSRemark: { canNull: true, reg: null, msg: ''},
    tel: { canNull: false, reg: /^[1-9][\d]{10}$/, msg: '电话号填写有误' },
    address: { canNull: true, reg: null, msg: ''},
    accomodationAddress: { canNull: false, reg: null, msg: ''},
    isSameAddress: { canNull: true, reg: null, msg: ''},
    checkInForm: {canNull: true, reg: null, msg: ''},
    visaDoc: { canNull: true, reg: null, msg: ''},
    passport: { canNull: true, reg: null, msg: ''},
    lackReason: { canNull: true, reg: null, msg: '' }
  }
}