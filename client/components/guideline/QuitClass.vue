<template>
  <div>
    ...
    <div class="container-header">
      <p class="header-text">退课申请流程</p>
    </div>
    <!--查询输入-->
    <div class="container-card-list">
      <p>点击“Go”按钮进入USC系统->NetId登录->教务->本科生退课申请</p>
      <a href="http://usc.sysu.edu.cn" target="_blank">
        <button class="manager-button">Go</button>
      </a>
    </div>
...
export default {
  ...
  methods: {
    /*leaveClick: function() {
      window.open('usc.sysu.edu.cn', '_blank')
    }*/
  }
}
</script>
