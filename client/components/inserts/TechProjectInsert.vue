...
<div id="container-insert-techProject">
  <div class="text-header">科研项目信息插入</div>
  <hr>
...
#container-insert-techProject .text-header {
  text-align: center;
  font-size: 25px;
  font-weight: bolder;
}

#container-insert-techProject .container-input {
  margin-left: 50px;
}

#container-insert-techProject .container-record {
  float: left;
  margin-top: 20px;
  margin-left: 20px;
}

#container-insert-techProject .container-record span {
...
#container-insert-techProject .container-record select, #container-insert-techProject .container-record input {
  margin-left: 10px;
  width: 250px;
  height: 30px;
  padding: 5px;
...
#container-insert-techProject #warning {
  float: left;
  clear: both;
  text-align: left;
  margin-top: 10px;
...
#container-insert-techProject .button-insert {
  float: left;
  clear: both;
  width: 110px;
  height: 36px;
...
#container-insert-techProject .button-insert:hover {
