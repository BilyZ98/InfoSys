...
<div id="container-insert-patent">
  <div class="text-header">获得专利情况插入</div>
  <hr>
...
#container-insert-patent .text-header {
  text-align: center;
  font-size: 25px;
  font-weight: bolder;
}

#container-insert-patent .container-input {
  margin-left: 50px;
}

#container-insert-patent .container-record {
  float: left;
  margin-top: 20px;
  margin-left: 20px;
}

#container-insert-patent .container-record span {
...
#container-insert-patent .container-record select, #container-insert-patent .container-record input {
  margin-left: 10px;
  width: 400px;
  height: 30px;
  padding: 5px;
...
#container-insert-patent #warning {
  float: left;
  clear: both;
  text-align: left;
  margin-top: 10px;
...
#container-insert-patent .button-insert {
  float: left;
  clear: both;
  width: 110px;
  height: 36px;
...
#container-insert-patent .button-insert:hover {
